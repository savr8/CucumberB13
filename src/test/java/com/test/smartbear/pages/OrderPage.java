...
public class OrderPage {
    ...
    public void provideProductInfo(String productName1, String quantity) {
        BrowserUtils.selectBy(this.productName, productName1, "text");
        this.quantity.clear();
        this.quantity.sendKeys(quantity);
    }

    public void provideAdressInfo(String name, String street, String city, String state, String zipCode) {
    ...
    public void providePaymentInfo(String cardNumber, String expireDate, String cardType) {
